...
export class MetricsInterceptor implements NestInterceptor {
  constructor(
    @InjectMetric('api_requests_total') private readonly requestsCounter: Counter<string>,
    @InjectMetric('api_request_duration_seconds') private readonly requestDuration: Histogram<string>,
  ) {}
